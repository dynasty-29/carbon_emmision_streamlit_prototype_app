...
with col1:
  Total = st.selectbox('Total', min=0.0, max_value=1000000.0, value=1.0)
  Coal = st.number_input('Coal', min=0.0, max_value=1000000.0, value=1.0)
  Gas = st.number_input('Gas', min=0.0, max_value=1000000.0, value=1.0)
    

with col2:
  Oil = st.number_input('Oil', min=0.0, max_value=1000000.0, value=1.0)
  Cement = st.number_input('Cement', min=0.0, max_value=1000000.0, value=1.0)
  Flaring = st.number_input('Flaring', min=0.0, max_value=1000000.0, value=1.0)
